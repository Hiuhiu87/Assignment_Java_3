...
public class ColorView extends javax.swing.JFrame {
    ...
    ColorProductService service = new ColorProductService();

    public ColorView() {
        initComponents();
        listColor = service.getAll();
        tblDisplay.setModel(tableModel);
        addColumnTable();
        fillTable(listColor);
    }

    private void fillTable(ArrayList<ColorProduct> list) {
        int stt = 0;
        tableModel.setRowCount(0);
        for (ColorProduct color : list) {
            stt++;
            Object[] row = {stt, color.getCode(), color.getName()};
    ...
    private void addColumnTable() {
        ...
        tableModel.addColumn("Mã Màu");
        tableModel.addColumn("Tên Màu");
    }
    
    private ColorProduct inputColor(){
        String colorName = "";
        if (txtNameColor.getText().isEmpty()) {
            labelNameColorError.setText("Trường Này Không Được Để Trống");
            return null;
        }else{
            colorName = txtNameColor.getText();
            labelNameColorError.setText("");
            ColorProduct colorProduct = new ColorProduct(colorName);
            return colorProduct;
        }
    }
    ...
    private void initComponents() {
        ...
        labelNameColorError = new javax.swing.JLabel();
        ...
        labelNameColorError.setForeground(new java.awt.Color(255, 51, 102));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(labelNameColorError, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(txtNameColor, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(labelNameColorError, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//    }
    ...
    private javax.swing.JLabel labelNameColorError;
