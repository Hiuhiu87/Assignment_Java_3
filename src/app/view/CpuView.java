...
public class CpuView extends javax.swing.JFrame {
    ...
    CPUInforService service = new CPUInforService();
    ...
    private void fillTable(ArrayList<CPUInfo> list) {
        int stt = 0;
        tableModel.setRowCount(0);
        for (CPUInfo cpu : list) {
            stt++;
            Object[] row = {stt, cpu.getCode(), cpu.getName()};
    ...
    private void addColumnTable() {
        ...
        tableModel.addColumn("Mã CPU");
        tableModel.addColumn("Tên CPU");
    }
    
    private CPUInfo inputCpu(){
        String cpuName = "";
        if (txtNameCpu.getText().isEmpty()) {
            labelNameCpuError.setText("Trường Này Không Được Để Trống");
            return null;
        }else{
            cpuName = txtNameCpu.getText();
            labelNameCpuError.setText("");
            CPUInfo cpu = new CPUInfo(cpuName);
            return cpu;
        }
    }
