...
public class CompanyView extends javax.swing.JFrame {
    ...
    public CompanyView() {
        initComponents();
        listCompany = service.getAll();
        tblDisplay.setModel(tableModel);
        addColumnTable();
        fillTable(listCompany);
    }

    private void fillTable(ArrayList<Company> list) {
        int stt = 0;
        tableModel.setRowCount(0);
        for (Company company : list) {
            stt++;
            Object[] row = {stt, company.getCode(), company.getName()};
    ...
    private void addColumnTable() {
        ...
        tableModel.addColumn("Mã NSX");
        tableModel.addColumn("Tên NSX");
    }
    ...
    private Company inputCompany(){
        ...
        if (txtNameCompany.getText().isEmpty()) {
            ...
            companyName = txtNameCompany.getText();
            labelNameCompanyError.setText("");
            Company cpn = new Company(companyName);
            return cpn;
        }
    }
