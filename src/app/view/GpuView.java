...
public class GpuView extends javax.swing.JFrame {
    ...
    GPUInforService service = new GPUInforService();

    public GpuView() {
        initComponents();
        listGpu = service.getAll();
        tblDisplay.setModel(tableModel);
        addColumnTable();
        fillTable(listGpu);
    }

    private void fillTable(ArrayList<GPUInfo> list) {
        int stt = 0;
        tableModel.setRowCount(0);
        for (GPUInfo gpu : list) {
            stt++;
            Object[] row = {stt, gpu.getCode(), gpu.getName()};
    ...
    private void addColumnTable() {
        ...
        tableModel.addColumn("Mã GPU");
        tableModel.addColumn("Tên GPU");
    }
    
    private GPUInfo inputGpu(){
        String gpuName = "";
        if (txtNameGpu.getText().isEmpty()) {
            labelNameGpuError.setText("Trường Này Không Được Để Trống");
            return null;
        }else{
            gpuName = txtNameGpu.getText();
            labelNameGpuError.setText("");
            GPUInfo gpu = new GPUInfo(gpuName);
            return gpu;
        }
    }
    ...
    private void initComponents() {
        ...
        txtNameGpu = new app.view.swing.TextField();
        ...
        txtNameGpu.setLabelText("Tên GPU");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtNameGpu, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(32, 32, 32)
                        .addComponent(txtNameGpu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//    }
    ...
    private app.view.swing.TextField txtNameGpu;
