...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelForgetPass = new javax.swing.JLabel();
        ...
        labelForgetPass.setText("Forget Your Password ?");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (txtAccount.getText().trim().isEmpty()) {
            countError++;
            labelEmailError.setText("Bạn Chưa Nhập Vào Email");
        } else {
        ...
        if (pswAccount.getText().trim().isEmpty()) {
            countError++;
            labelPasswordError.setText("Bạn Chưa Nhập Vào Mật Khẩu");
        } else {
            password = String.valueOf(pswAccount.getPassword());
        ...
        if (countError == 0) {
            ...
            if (userLogin.getId() != null) {
                MainApplication app = new MainApplication(userLogin);
                this.dispose();
                JOptionPane.showMessageDialog(this, "Chào Mừng " + userLogin.getName() + " Quay Trở Lại !");
                app.setVisible(true);
            } else {
    ...
    private javax.swing.JLabel labelForgetPass;
